...
<body>
    ...
    <main>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-10 mx-auto">
                        <h2 class="mb-4 text-center" data-aos="fade-up">Latest News and Updates</h2>
        ...
        <section class="related-news section-padding">
            <div class="container">
                <h2 class="mb-3 text-center" data-aos="fade-up">News Archives</h2>
                <div class="row">
                    <div class="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel" data-interval="1000">
                        <div class="MultiCarousel-inner">
                            ...
                            <div class="item">
                                <div class="pad15">
                                    <p class="lead">BPPA Annual Meeting 9th and 10th November 2019 Programme</p>
                                    <p>08/10/2019</p>
                                    <small>read more</small>
                                </div>
                            </div>
