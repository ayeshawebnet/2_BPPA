    ...
    <div class="pricing-card">
        <div class="demo10">
            <div class="container">
                ...
                <div class="row">
                      <div >
                        <img src="../2_BPPA/images/logo/BPPA-white.png" width="100%" alt="">
                      </div>  
                      <hr class="member-hr">
                    <div clasS="col-md-12 m-4">
                        ...
                        <ol class="left-content-sub-text">
                            <li>Pay Online: Securely pay your Membership fee online through our website. Simply select the "Membership" option during checkout, and complete your payment.
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="pricingTable10">
                            ...
                            <div class="pricing-content">
                                ...
                                <a href="#" class="read">Buy with Gpay</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
